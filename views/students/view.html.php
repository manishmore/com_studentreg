...
/**
 * View class for a list of Studentreg.
 */
class StudentregViewStudents extends JView
{
	protected $items;
	...
	public function display($tpl = null)
	{
        ...
        StudentregHelper::addSubmenu($view);
	...
	protected function addToolbar()
	{
		...
		$canDo	= StudentregHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_STUDENTREG_TITLE_STUDENTS'), 'students.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_studentreg');
		}
